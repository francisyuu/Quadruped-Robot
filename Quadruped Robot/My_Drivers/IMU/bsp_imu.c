...
void mpu_get_data()
{
    ...
    mpu_data.gz = ((int16_t)(mpu_buff[12] << 8 | mpu_buff[13]) - mpu_data.gz_offset);
...
void mpu_offset_call(void)
{
	...
	mpu_data.ax_offset=mpu_data.ax_offset / OFFSET_SAMPLE_NUM;
	mpu_data.ay_offset=mpu_data.ay_offset / OFFSET_SAMPLE_NUM;
	mpu_data.az_offset=mpu_data.az_offset / OFFSET_SAMPLE_NUM;
	mpu_data.gx_offset=mpu_data.gx_offset / OFFSET_SAMPLE_NUM;
	mpu_data.gy_offset=mpu_data.gy_offset / OFFSET_SAMPLE_NUM;
	mpu_data.gz_offset=mpu_data.gz_offset / OFFSET_SAMPLE_NUM;
}
